...
(sudo crontab -l | grep -v update.sh ; echo "*/30 * * * * /home/pi/oms-client/update.sh >> ${log_dir}/cron.log 2>&1") | crontab -
...
(sudo crontab -l | grep -v delete-log ; echo "0 0 1 * * ${script_dir}/delete-log.sh >> ${log_dir}/cron.log 2>&1") | crontab -